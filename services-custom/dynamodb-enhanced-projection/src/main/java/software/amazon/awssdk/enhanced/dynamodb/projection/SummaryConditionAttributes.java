...
@SdkInternalApi
final class SummaryConditionAttributes {

    private SummaryConditionAttributes() {
    }

    static void collect(Condition condition, Set<String> attrs) {
        ConditionEvaluator.collectAttributes(condition, attrs);
    }
}
